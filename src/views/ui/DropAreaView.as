...
public class DropAreaView extends Sprite {
  ...
  public function DropAreaView() {
    ...
    _tf2.htmlText += 'Remove current image';
    ...
    _tf2.defaultTextFormat = new TextFormat(Assets.FONT1, 8, 0x00FF00, false);
    _tf2.htmlText += 'Scale image +0.25';
    _tf2.htmlText += 'Scale image -0.25';
    _tf2.defaultTextFormat = new TextFormat(Assets.FONT1, 8, 0xBBBBBB, false);
    _tf2.htmlText += '<br/>';
    _tf2.htmlText += '<br/>';
